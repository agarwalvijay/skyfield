...
export function AlertBanner({ alerts }: { alerts: WeatherAlert[]; accent: string }) {
  ...
  const toggleMutedAlert = useSettings((s) => s.toggleMutedAlert);
  const top = alerts[0];
  ...
  return (
    <>
      ...
      >
        <button className="alert-banner-main" onClick={() => setOpen(top)}>
        ...
        <button
          className="alert-banner-bell"
          onClick={() => toggleMutedAlert(top.event)}
          aria-label={`Mute ${top.event}`}
          title={`Mute “${top.event}”`}
        >
            ...
            >
              ...
              <div className="reader-body">
                ...
                >
                  ...
                  Mute “{open.event}” — hide &amp; stop alerts
                </button>
